...
/**
 * Created by amr masoud on 6/24/2016.
 */
public class InterstedAdapter extends BaseExpandableListAdapter {
    private Context _context;
    private ArrayList<String> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, ArrayList<String>> _listDataChild;

    public InterstedAdapter(Context _context, ArrayList<String> _listDataHeader, HashMap<String, ArrayList<String>> _listDataChild) {
